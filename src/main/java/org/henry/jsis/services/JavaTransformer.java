 ...
 * @since 21/01/2023
 **/
public class JavaTransformer implements JavaServiceObject {
    protected final JavaServiceInfo javaServiceInfo;
    protected final String name = "Transformer";
    protected final String path = "/transformer/";

    public JavaTransformer(JavaServiceInfo javaServiceInfo) {
