 ...
 * @since 21/01/2023
 **/
public class JavaController implements JavaServiceObject {
    protected final JavaServiceInfo javaServiceInfo;
    protected final String name = "Controller";
    protected final String path = "/controller/";

    public JavaController(JavaServiceInfo javaServiceInfo) {
